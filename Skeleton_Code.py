...
class Puzzle():
  def __init__(self, *args):
    if len(args) == 1:
      ...
      # QPattern1 = Pattern('Q', '*QQQ**Q*Q')
      # self.__AllowedPatterns.append(QPattern1)
      # self.__AllowedSymbols.append("Q")
      # QPattern2 = Pattern('Q', 'Q**QQ**QQ')
      # self.__AllowedPatterns.append(QPattern2)
      # self.__AllowedSymbols.append("Q")
      # QPattern3 = Pattern('Q', '**Q**QQQQ')
      # self.__AllowedPatterns.append(QPattern3)
      # self.__AllowedSymbols.append("Q")
      ...
      TPattern1 = Pattern("T", "**TTT**TT")
      self.__AllowedPatterns.append(TPattern1)
      self.__AllowedSymbols.append("T")
      TPattern2 = Pattern("T", "*T**TTT*T")
      self.__AllowedPatterns.append(TPattern2)
      self.__AllowedSymbols.append("T")
      TPattern3 = Pattern("T", "T**T**TTT")
      self.__AllowedPatterns.append(TPattern3)
      self.__AllowedSymbols.append("T")
  ...
  def AttemptPuzzle(self):
    ...
    while not Finished:
      ...
      # remove = input('Do you want to remove a symbol from a cell')
      # if remove.lower() == 'y':
      #   Valid = True
      # else:
      #   Valid = False
      ...
      # if CurrentCell == '@':
      #   print("Invalid cell to remove")
      #   Valid = True
      # else:
      #   Symbol = '@'
      #   CurrentCell.ChangeSymbolInCell(Symbol)
      #   DeductScore = self.CheckforMatchWithPattern(Row, Column)
...
class Cell():
  ...
  def getNotAllowedSymbols(self, AddToNotAllowedSymbols):
    self.getNotAllowedSymbols = self.__SymbolsNotAllowed
